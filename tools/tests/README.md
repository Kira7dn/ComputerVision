...
| `integration/` | Cross-component integration checks; package-owned Frigate checks remain in `frigate/frigate/test/` | `python -m pytest frigate/frigate/test/test_evidence_quality.py frigate/frigate/test/test_recognition_lifecycle.py -q` |
| `e2e/` | Real Docker/Frigate/replay runtime test | `python tools/tests/e2e/run_platform_runtime_test.py` |
