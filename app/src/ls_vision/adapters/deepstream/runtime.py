...
from ls_vision.adapters.media.mock_input import wait_for_rtsp_video
from ls_vision.adapters.models.dms_engine import (
    DmsBehaviorEngine,
    DmsInferenceResult,
    select_dms_overlay_detections,
)
from ls_vision.adapters.models.face_engine import FaceRecognitionEngine
...
from ls_vision.bootstrap.config import load_config, load_raw_config
...
from ls_vision.domain.contracts import AnalysisSample, FrameKey, FunctionResult  # noqa: E402
from ls_vision.domain.dms_events import DmsAlertEventStore  # noqa: E402
from ls_vision.domain.dms_health import (  # noqa: E402
    requires_person_inference,
    resolve_dms_health,
)
from ls_vision.domain.fire_smoke_events import FireSmokeEventStore  # noqa: E402
from ls_vision.domain.front_assistance import (  # noqa: E402
    FrontAlertTransition,
    FrontPerception,
    VisionAlertPolicy,
)
from ls_vision.domain.front_overlay import project_front_overlay  # noqa: E402
from ls_vision.domain.recognition import RecognitionCore, TrackKey  # noqa: E402
from ls_vision.domain.smoking_events import SmokingEpisodeStore, SmokingInferenceBatch  # noqa: E402
from ls_vision.domain.tracking import (  # noqa: E402
    PersonConfirmation,
    ...
    def _start_mock_publisher(self) -> None:
        ...
        if shutil.which("ffmpeg") and not synchronized:
            ...
            command = [
                sys.executable,
                "-m",
                "ls_vision.adapters.media.gstreamer_mock_publisher",
                "--input",
                str(mock_video),
                "--output",
                str(input_cfg["rtsp_url"]),
