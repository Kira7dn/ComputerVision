...
from ls_vision.adapters.models.smoking_object_detector import SmokingObjectDetector
from ls_vision.domain.smoking_events import SmokingInferenceBatch, SmokingObservation
