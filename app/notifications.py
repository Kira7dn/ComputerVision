...
This module reuses the provider HTTP contracts from the Frigate notification
implementation, but deliberately has no Frigate import or runtime dependency.
