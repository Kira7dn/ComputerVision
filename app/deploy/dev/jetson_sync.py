"""Synchronize Camera/app changes to a native Jetson development runtime.
...
Secrets outside Camera/app are intentionally never synchronized.
"""
...
def main() -> int:
    args = parse_args()
    app_root = (args.root.resolve() / "app").resolve()
