...
VIDEO_DIR = Path(__file__).resolve().parent.parent / 'uploads' / 'videos'
QUEUE_DB = Path(__file__).resolve().parent.parent / 'uploads' / 'cloud_queue.sqlite3'
...
def main():
    ...
    parser.add_argument('--user', default='dahua')
    parser.add_argument('--password', default='letron-dahua-upload')
    ...
    authorizer.add_user(args.user, args.password, str(VIDEO_DIR), perm='elradfmwMT')
