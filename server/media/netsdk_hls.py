...
from NetSDK.SDK_Callback import fDataCallBackEx, fDisConnect, fHaveReConnect
...
class NetSdkHlsManager:
    ...
    def __init__(self, output_root, event_log, host='192.168.100.229',
        ...
        self.password = password or os.environ.get('DAHUA_PASSWORD', 'letron123')
    ...
    def start(self, channel, subtype=0):
        ...
        command = [
            ...
            '-fflags', '+genpts', '-f', input_format, '-i', 'pipe:0',
        ...
        try:
            ...
            # truth for ADAS and keep the TS timestamp callback for legacy HLS.
